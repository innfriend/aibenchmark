          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>enterprise@corepick.ai</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0D1322] border border-[#1E293B] rounded-2xl p-6 sm:p-8 space-y-4">
            {submitted ? (
              <div className="py-8 text-center space-y-3">
                ...
                <h4 className="text-base font-bold text-white font-mono">Inquiry Received</h4>
                <p className="text-xs text-slate-400">
                  Thank you! A CorePick performance engineer will reach out to you within 24 hours.
                </p>
              </div>
            ) : (
