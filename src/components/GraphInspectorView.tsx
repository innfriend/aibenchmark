                      ...
                      >
                        ...
                        <div className="grid grid-cols-4 gap-2 mt-3 pt-2 border-t border-white/10 text-[11px] font-mono">
                          <div>
                            ...
                            <span className="font-bold text-white">{node.durationMs.toFixed(2)} ms</span>
                          </div>
                          <div>
                            <span className="text-slate-400 block text-[9px]">FLOPs:</span>
                            <span className="font-bold text-white">{node.flopsGflops.toFixed(1)} GFLOPs</span>
                          </div>
                          <div>
                            <span className="text-slate-400 block text-[9px]">Bandwidth:</span>
                            <span className="font-bold text-cyan-300">{node.memoryBandwidthGBs} GB/s</span>
                          </div>
                          <div>
                            <span className="text-slate-400 block text-[9px]">Arithmetic Int.:</span>
                            <span className="font-bold text-emerald-300">{node.arithmeticIntensity.toFixed(1)} F/B</span>
                          </div>
                        </div>
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-[#131B2E] p-3 rounded-xl border border-[#27354F]">
                    ...
                    <span className="text-lg font-bold text-white font-mono">{selectedNode.durationMs.toFixed(2)} ms</span>
                  </div>
                  <div className="bg-[#131B2E] p-3 rounded-xl border border-[#27354F]">
                    <span className="text-[10px] text-slate-400 block font-mono">Memory Traffic</span>
                    <span className="text-lg font-bold text-cyan-300 font-mono">{selectedNode.memoryBandwidthGBs} GB/s</span>
                  </div>
                </div>
                ...
                <div className="bg-[#07090E] p-4 rounded-2xl border border-[#1E293B] space-y-2">
                  ...
                  <div className="flex items-center justify-between text-xs font-mono">
                    ...
                    <span className="font-bold text-amber-300">{selectedNode.quantizationSensitivityScore.toFixed(1)} / 10</span>
                  </div>
                  <div className="w-full bg-[#131B2E] h-2 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ width: `${selectedNode.quantizationSensitivityScore * 10}%` }}
                    />
                  </div>
                </div>
          ...
          <div className="bg-[#07090E] border border-[#1E293B] rounded-2xl p-6 relative min-h-[380px] flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center text-xs font-mono border-b border-[#1E293B] pb-3">
              ...
              <div className="space-y-0.5 text-center">
                ...
                <span className="text-amber-400 font-bold text-sm">{rooflineConfig.ridgePointFlopsPerByte.toFixed(1)} FLOPs/B</span>
              </div>
              ...
              <tbody className="divide-y divide-[#1E293B]">
                {rooflineConfig.kernels.map((kernel, idx) => (
                  <tr key={idx} className="hover:bg-[#131B2E]">
                    ...
                    <td className="py-3 px-3 text-slate-300">{kernel.arithmeticIntensity.toFixed(1)} FLOPs/B</td>
                    <td className="py-3 px-3 font-bold text-emerald-300">{kernel.performanceTflops.toFixed(1)} TFLOPs/s</td>
